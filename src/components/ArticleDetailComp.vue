...
export default {
    ...
    methods: {
        ...
        getArticleDetail(id) {
            this.axios.get('http://47.100.60.198:5000/article/'+id).then(resp => {
        ...
        async sendComment() {
            ...
            await this.axios.post('http://47.100.60.198:5000/sendcomment', data).then(resp => {console.log(resp)});
            this.getComments(this.$route.params.article_id)
        },
        // 如果还没有登录的话，需要先跳转登录
        loginFirst() {
        ...
        getComments(articleId) {
            ...
            return this.axios.post('http://47.100.60.198:5000/comments/'+articleId, data).then(resp => {

                ...
                <div @mouseenter="isHover(index)" @mouseleave="noHover(index)">
                    <div class="picture-abstract">
                        <div class="article-pic" ref="picture">
                            <div :style="'backgroundImage:url(https://southdog.cool:9999/static/articles/'+item.id+'/cover/'+item.cover+');backgroundSize:cover;'" class="cover"></div>
                            <!-- <div style="backgroundImage:url(https://southdog.cool:9999/static/articles/1/cover/cover.jpg);backgroundSize:cover" class="cover"></div> -->
                        </div>
                    </div>
...
export default {
    ...
    methods: {
        ...
        getArticle() {
            ...
            return this.axios.post('https://southdog.cool:9999/getarticle', data).then(r => {
